...
class Kernel extends \Symfony\Component\HttpKernel\Kernel
{
    ...
    protected function configureRoutes(RouteCollectionBuilder $routes)
    {
        ...
        $routes
            ...
            ->setMethods(['GET']);
        $routes
            ->add('/admin/satis/buildRepo', $controllerBase . 'SatisController::buildRepoAction', 'satis_build_repo')
            ->setMethods(['GET'])
	    ->setRequirement('repository', '.+');
        $routes
            ->add('/admin/satis/buildRun', $controllerBase . 'SatisController::buildRunAction', 'satis_build_run')
            ->setMethods(['GET']);
        $routes
            ->add('/admin/satis/buildRunRepo/{repository}', $controllerBase . 'SatisController::buildRunRepoAction', 'satis_build_run_repo')
            ->setMethods(['GET'])
	    ->setRequirement('repository', '.+');
        // webhooks
        $routes
